...
export class Music {
  ...
  save(fileName: string){
	...
	private _play(time: number, duration: number, instrument: string, noteList: Array<number | NoteType>, velocity: number = 85 ): TimeNote
	{
   ...
   */
  play(instrument: string, noteList: Array<number | NoteType>, inputDuration?: TimeType, velocity: number = 85 ): void
  {
